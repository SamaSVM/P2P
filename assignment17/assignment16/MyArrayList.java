...
public class MyArrayList<T> {
    ...
    /**
     * A method that searches from the end in an array for an element to be transmitted.
     *
     * @param element element that is searched in the array.
     * @return index if such an element is in the array, -1 if there is no such element.
     */
