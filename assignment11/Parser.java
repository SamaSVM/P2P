...
class Parser implements Variables {
     ...
     */
    static ArrayList<String> preparationOfTheFormula(String formula) {
     ...
     * @param formula    the formula entered by the user.
     */
    static void parsFormula(ArrayList<String> arraySplit, String formula) {
     ...
     */
    private static void parsingBrackets(ArrayList<String> arraySplit) {
     ...
     */
    private static void parsingTrigonometricSigns(ArrayList<String> arraySplit) {
