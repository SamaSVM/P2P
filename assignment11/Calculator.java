package com.shpp.p2p.cs.vsamchenko.exam.assignment11;
...
public class Calculator implements Variables {
    ...
    static double calculate(String formula) {
        ArrayList<String> arraySplit = Parser.preparationOfTheFormula(formula);
     ...
     */
    private static void conductingTrigonometricOperations(ArrayList<String> arraySplit, int index) {
     ...
     * @param arraySplit list of all elements of the formula.
     */
    private static void countInsideParentheses(ArrayList<String> arraySplit) {
     ...
     */
    private static void replaceOfVariablesWithValues(ArrayList<String> arraySplit) {
     ...
     */
    private static void subtraction(ArrayList<String> arraySplit, int index) {
     ...
     * @param index      an index that shows where the list sign is.
     */
    private static void addition(ArrayList<String> arraySplit, int index) {
        double res = parseDouble(arraySplit.get(index - 1)) + parseDouble(arraySplit.get(index + 1));
        arraySplit.add(index - 1, Double.toString(res));
        removeUnnecessary(arraySplit, index);
    }
     ...
     * @param index      an index that shows where the list sign is.
     */
    private static void division(ArrayList<String> arraySplit, int index) {
        double res = parseDouble(arraySplit.get(index - 1)) / parseDouble(arraySplit.get(index + 1));
        arraySplit.add(index - 1, Double.toString(res));
        removeUnnecessary(arraySplit, index);
    }
     ...
     * @param index      an index that shows where the list sign is.
     */
    private static void multiplication(ArrayList<String> arraySplit, int index) {
        double res = parseDouble(arraySplit.get(index - 1)) * parseDouble(arraySplit.get(index + 1));
        arraySplit.add(index - 1, Double.toString(res));
        removeUnnecessary(arraySplit, index);
    }
     ...
     * @param index      an index that shows where the list sign is.
     */
    private static void elevationToTheDegree(ArrayList<String> arraySplit, int index) {
     ...
     */
    private static void removeUnnecessary(ArrayList<String> arraySplit, int index) {
