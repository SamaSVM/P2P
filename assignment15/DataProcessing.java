...
class DataProcessing {
    ...
    static void compress(String nameInputFile, String nameOutputFile) {
        ...
        Map<Byte, Integer> freqMap = buildTableBytes(byteInputFile);

        // Add all the nodesTree in Queue.
        PriorityQueue<TreeNode> nodesTree = buildNodesQueue(freqMap);
        ...
        HashMap<Byte, String> tableBitCodes = buildBitCodeTable(freqMap, rootTreeHuffman);
        ...
        ArrayList<Byte> codedElements = TreeNode.getCodedElements();
     ...
     */
    private static PriorityQueue<TreeNode> buildNodesQueue(Map<Byte, Integer> freqMap) {
        PriorityQueue<TreeNode> nodesTree = new PriorityQueue<>();
     ...
     */
    private static HashMap<Byte, String> buildBitCodeTable(Map<Byte, Integer> freqMap, TreeNode rootTreeHuffman) {
        HashMap<Byte, String> bitCodeTable = new HashMap<>();
        for (Byte b : freqMap.keySet()) {
    ...
    static void decompress(String nameInputFile, String nameOutputFile) {
        ...
        ArrayList<Byte> codedElements = new ArrayList<>();
    ...
    private static int saveOutputFileForCompress(String nameOutputFile, StringBuilder outputString,
                                                 StringBuilder treeStructure, ArrayList<Byte> codedElements) {
     ...
     */
    private static HashMap<Byte, Integer> buildTableBytes(byte[] bytesFile) {
     ...
     */
    private static TreeNode buildTreeHuffman(Queue<TreeNode> nodes) {
        while (nodes.size() > 1) {
