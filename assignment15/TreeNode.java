...
class TreeNode implements Comparable<TreeNode> {
    ...
    private static final ArrayList<Byte> codedElements = new ArrayList<>();
     ...
     */
    TreeNode getTreeFromString(StringBuilder treeStructure, ArrayList<Byte> codedElements) {
     ...
     */
    static ArrayList<Byte> getCodedElements() {
